        ...
        <div id="PageContainer" class="is-moved-by-drawer">
            ...
            <main class="main-content" style="background-color: #50d8af1f;padding-top: 20px;margin-top: -20px;">                      
                ...
                <div class="content">          
					...
					<?php 
				$li=mysqli_query($con,"SELECT * FROM `blog`");
				 //echo "<pre>"; print_r($limit);
				 while($limit=mysqli_fetch_array($li)){ 
				?>
                                        ...
                                        <div class="grid__item block_heading grid--table grid--full style_default">      
                                            <div class="area-header grid__item one-third">
                                                <h2>
                                                    ...
                                                    <a class="colortext" href="blog-article-each-one.php?bid=<?php  print_r($limit['blog_id']); ?>">Latest topic from <?php print_r($limit['category']);  ?></a>
                                                </h2>
                                            </div>    
                                        ...
                                        <div class="grid__item block_content grid--table grid--full">   
                                                        ...
                                                        <div id="sync5" class="wrapper article-grid">
                                                                <div class="grid--rev blog_list item">
                                                                    ...
                                                                    <div class="article__image">
																		...
																		<?php if(!empty($limit['image'])) { ?>
																		<a class="article__featured-image" href="">
																		
                                                                        <img src="Blogimage/<?php print_r($limit['image']);  ?>" alt="These are the 5 best phones you can buy right now">
                                                                        </a>
																		<?php } ?>
                                                                    </div>
                                                                    <h2 class="h3"><a href=""><?php //print_r($limit['content']); ?></a></h2>
                                                                  
                                                                    <div class="article__bottom">
																	<b>Short Description </b>
                                                                        <div class="rte rte--indented-images">
                                                                            <?php print_r($limit['short_desc']);  ?>
                                                                        </div>
                                                                    ...
                                                                    <div class="article__bottom" style="display:  inline-flex;width: 100%;">
                                                                        <div class="one-half">
                                                                          <div class="article__date">
                                                                            <span class="author"><b>Created By:</b> <?php print_r($limit['user']);  ?></span>
                                                                           <time datetime="2016-12-13" class="date"> <span><b>Date:</b></span><?php print_r($limit['create_on']);  ?></time> 
                                                                          </div>
                                                                        </div>                    
                                                ...
                                                <div class="grid__item content_products one-third" style="margin-top:6px;width: 35%;">
                                                  <div class="row" style="display:  inline-flex;padding: 3%;background: #fff;padding-bottom: 0;">
                                                    <div class="one-third">
                                                      <img src="Blogimage/<?php print_r($limit['image']);  ?>" alt="">
                                                    </div>
                                                    <div class="two-thirds" style="padding: 7px 14px;">
                                                      <h4 style="overflow: hidden;white-space: nowrap;text-overflow: ellipsis;"><?php print_r($limit['title']); ?></h4>
                                                      <div class="rte rte--indented-images" style="font-size: 12px;text-align: justify;">
                                                      <b>Catogery</b><?php print_r($limit['category']);  ?>
