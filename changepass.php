        ...
        <div id="PageContainer" class="is-moved-by-drawer">
            ...
            <main class="main-content" style="background-color: #50d8af1f;">                      
                <div class="content">  
                   ...
                   <div style="min-height:500px;margin-top:7%;">
...
$('#number3').jQuerySimpleCounter({end: 81,duration: 3100});
  ...
  <script>
      function changePassword(){
        ...
        if(NewPassword == ''){
            $('#NewEr1').html('Plese Provide Password');
            $('#NewEr1').css('display','block');
            setTimeout(function() { 
              $('#NewEr1').css('display','none');    
            },4000);
            
        }else if(NewPassword != ReNewPassword){
            $('#NewEr2').html('Retyupe password doesn\'t match with password');
            $('#NewEr2').css('display','block');
            setTimeout(function() { 
              $('#NewEr2').css('display','none');    
            },4000);
        }else{
              var useremail = '<?php echo $_REQUEST['email']; ?>';
              var url = "changedpass.php?NewPassword="+NewPassword+"&useremail="+useremail;
              console.log(url);
              ...
              xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    console.log(res);
                    if(res == '1'){
                        $('.ErMeg').html('Changed successfully');
                        $('.ErMeg').css('color','green');
                        $('.ErMeg').css('display','block');
                        setTimeout(function() { 
                          $('.ErMeg').css('display','none');    
                        },4000);
                    }
