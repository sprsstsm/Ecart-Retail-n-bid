...
<head>  
  ...
  <link href="table_cus.css" rel="stylesheet" type="text/css" media="all"> 
                  ...
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                        ...
                        <?php
                        $abc = mysqli_query($con,"SELECT * FROM `blog` WHERE `user_id`='".$_SESSION['user_id']."'  ORDER BY `blog_id` DESC ");
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                     $blogger = mysqli_fetch_assoc(mysqli_query($con,"SELECT `username` FROM user WHERE `id` ='".$row['user_id']."'"));
                                    echo $blogger['username'];

                                ?>
                            <td>
                              <a href="update_blog.php?blog_id=<?php echo $row['blog_id'];?>">
                              <label class="badge badge-danger">Blog</label>
                              </a>
                            </td>
                            <td>
                              <label class="badge badge-success"><?php echo $row['admin_approval'];?></label>
                            </td>
...
$('#number3').jQuerySimpleCounter({end: 8548,duration: 3100});
  ...
  <script src="admin/node_modules/datatables.net/js/jquery.dataTables.js"></script>
  <script src="admin/node_modules/datatables.net-bs4/js/dataTables.bootstrap4.js"></script>
