...
<?php 
   if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $query = "INSERT INTO `blog`(`user`, `user_id`, `category`, `title`, `content`,`image`, `create_on`) VALUES ('$user','$user_id','$blog_category','$blog_title','$blog_content','$file_name','$TIMESTAMP')";
...
.btnContactSubmit
{
    ...
    <body id="digital-world-store" class="template-index" >
        ...
        <div id="PageContainer" class="is-moved-by-drawer">
            ...
            <form href="add_blog.php" id="BlogUpload" name="BlogUpload" method="POST" enctype="multipart/form-data">
                <h3>Create Blog</h3>
               <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                 <input type="text"  class="form-control" placeholder="Blog Category *"  id="blog_category" name="blog_category">
