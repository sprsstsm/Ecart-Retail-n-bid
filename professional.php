                                                ...
                                                <div class="grid__item ">
                                                    <div class="grid-view-item" style="    padding: 0;">
                                                        <div class="grid-normal-display">
                                                                <div class="grid__image product-image" style="background-image: url(assets/images/profess.jpg);background-size: cover;    margin-bottom: 0;
                                                                border-radius: 8px;">
                                                                    ...
                                                                    <div class="one-third" style="    float: right;margin: 14%;margin-right: 10%;">
                                                                            <div class="contact-form" style="padding: 25px;padding-bottom: 62px;background-color: rgba(255, 255, 255, 0.61);">
                                                                                    ...
                                                                                    <button type="submit" class="btn right js-login-modal" data-mfp-src="#liveModal" value="Login" style="width: 100%;margin-bottom: 6%;">Create Professional Account</button>
                    ...
                    <div class="index-sections">
                      ...
                      <div class="grid__item block_heading grid--table grid--full style_default">      
                          <div class="area-header grid__item " style="width: 100%;text-align: center;">
                              <h2>
                                 <a class="colortext">Grow With JLODA Locally</a>
                              </h2>
                          </div>    
                                                            ...
                                                            <div class="grid-normal-display">
                                                                    <div class="grid__image product-image" style="width: 100%;margin-bottom: 0;">
                                                                        <a class="grid-view-item__link" href="" style="text-align:  center;">
                                                                                <i class="fa fa-calendar fa-5x foohover"></i>                                                                       </a>
                                        ...
                                        <a href="" class="colortext" style="font-weight: bold;font-size: 25px;">Appointment</a>
                                        <span style="font-size: 11px;color: #50d8af; font-size:14px;">made through JLODA</span>
                                                                            </div>
                                                                    </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="grid-view-item  hovero">
                                                            <div class="grid-normal-display">
                                                                    <div class="grid__image product-image" style="width: 100%;margin-bottom: 0;">
                                                                            ...
                                                                            <div class="h2 grid-view-item__title" style="text-align:  center;display:grid;">
                                          <a href="" class="colortext" style="font-weight: bold;font-size: 25px;">Professionals</a>
                                          <span style="font-size: 11px;color: #50d8af;font-size: 14px;">working with us</span>
                                                                                </div>
                                                                        </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="grid__item small--one-half medium-up--one-quarter one-third">
                                                        <div class="grid-view-item hovero">
                                                            <div class="grid-normal-display">
                                                                    <div class="grid__image product-image" style="width: 100%;margin-bottom: 0;">
                                                                            <a class="grid-view-item__link" href="" style="text-align:  center;">
                                                                                    <i class="fa fa-user fa-5x foohover"></i>
                                                                            </a>
                                                                            <div style="width: 100%;margin-top: 4%;">
                                          ...
                                          <span style="font-size: 11px;color: #50d8af;font-size: 14px;">feel happy with our service</span>
                                                                                </div>
                                                                        </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="wrapper"  style="padding: 0;">
                                            <div class="home-product-sidebar-wrapper grid--table grid--full" style="padding-top:10px; padding-bottom:10px;">
                                                <div class="grid__item block_heading grid--table grid--full style_default">      
                                                    <div class="area-header grid__item " style="width: 100%;text-align: center;">
                                                        <h2>
                                                           <a class="colortext">Professional Testimonials</a>
                                                        </h2>
                                                    </div>    
                                                                    ...
                                                                    <div id="customers-testimonials" class="owl-carousel">
                                                                      ...
                                                                      <div class="item">
                                                                          <div class="shadow-effect">
                                                                            ...
                                                                            <div class="testimonial-name">Dummy Name<br><span style="color: #50d8af;font-size: 12px;">Professional</span></div>
                                                                        </div>
