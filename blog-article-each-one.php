...
.colortext:hover{
            ...
            <div id="html-section-product-template" class="html-section" style="margin-top: 2%;">
                    ...
                    border-bottom: 2px solid #eee;">
                        <div class="wrapper">
                            ...
                            <?php
                            $bid=$_GET["bid"];
                            $cat_r=mysqli_fetch_array(mysqli_query($con,"SELECT category  FROM    blog where blog_id=$bid"));
                              
                            ?>

                            <span>Blog Categories> > <?php print_r($cat_r['category']); ?></span>
    ...
    $blogid=$_GET["bid"];
  // echo "bhgcfcfcfcfcfcfcfcfcfcfcfcfcfcfcfcfcfcfcfcfcfcfcf"; echo $blogid;
    $userdetail = mysqli_query($con,"SELECT *  FROM    blog  where blog_id= $blogid");
                                    ...
                                    <div class="home-product-sidebar-wrapper grid--table grid--full" style="padding-top:10px; padding-bottom:10px;">
                                        <div class="grid__item block_heading grid--table grid--full style_default">      
                                            <div class="area-header grid__item one-third">
                                                <h2>
                                                    ...
                                                    <a class="colortext" href="blog-article-each-one.php">Latest Blogs from <?php print_r($result['category']);   ?></a>
                                                </h2>
                                            </div>   
                                        ...
                                        <div class="grid__item block_content grid--table grid--full">   
                                                ...
                                                <div class="grid__item content_products two-thirds" style="padding-left: 3.5%;width: 65%;"  >        
                                                    ...
                                                    <h2 class="h3"><a href=""><b>Short Description </b><?php  echo $result['short_desc'] ?></a></h2>
