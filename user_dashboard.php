...
<style type="text/css">
    ...
    <body id="digital-world-store" class="template-index" >
        ...
        <div id="PageContainer" class="is-moved-by-drawer">
            ...
            <?php include('user_side_panel.php'); ?>

           

            <div class="main_panel home-product-sidebar-wrapper grid--table grid--full Page-Content">

            <div class="container emp-profile row">

            <div class="col-md-7 cus_right_limit">

                <div class="row cus_row" >
                        <div class="col-md-9">Source</div>
                        <div class="col-md-3">Point Earned</div>
                </div>
                ...
                <div class="row cus_row">
                    ...
                    <div class="grid-normal-display" style="text-align: left;">
                        <div class="grid__image product-image" style="display:  inline-flex;width: 100%;margin-bottom: 0;">
                            <a class="grid-view-item__link one-quarter footicon" href="blog-article.php?blog_id=1">
                        <img src="Blogimage/android.jpg" style="width: 100%;height: 100%;margin-top: -16px;">
                            </a>
                            <div style="width: 100%;padding: 0 10px;">
                                <div class="h2 grid-view-item__title">
                                    <a href="blog-article.php?blog_id=1" style="font-weight: bold;    font-size: 14px;">Android</a>
                                </div>
                                <div class="grid-view-item__meta">
                                    <span class="product-price__price LimitText" style="color: #888;font-size: 13px;"> the title of the post goes in your email subject line; the body text goes in the body of the email. Post a blog by email from your mobile device. </span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-3">2 poimt</div>
                </div>
                ...
                <div class="row cus_row">
                        <div class="col-md-9">Direct Cash Payment</div>
                        <div class="col-md-3">10 points</div>
                </div>
                <div class="row cus_row">
                        <div class="col-md-9">Cash On Ddelivery</div>
                        <div class="col-md-3">15 points</div>
                </div>
                
                <div class="row cus_row">
                        <div class="col-md-9">Temporary Appointment</div>
                        <div class="col-md-3">5 points</div>
                </div>

                <div class="row cus_row">
                        <div class="col-md-9">Permanent Appointment</div>
                        <div class="col-md-3">10 points</div>
                </div>
                <div class="row cus_row">
                        <div class="col-md-9">Total Points</div>
                        <div class="col-md-3">46 points</div>
                </div>
            ...
            <div class="col-md-5 cus_limit cus_left_limit">
...
<div class="row cus_row">
                        ...
                        <div class="col-md-3">Eligible</div>
                </div><div class="row cus_row">
                        <div class="col-md-6"><img src="https://upload.wikimedia.org/wikipedia/commons/4/42/Paytm_logo.png" style="
    width: 50%;
">
    <p>₹ 100 Cash Back </p>
</div>
                        <div class="col-md-3">500</div>
                        <div class="col-md-3"><input type="checkbox" name="vehicle3" value="Boat" checked=""></div>
                </div>

<div class="row cus_row">
                        <div class="col-md-6"><img src="https://upload.wikimedia.org/wikipedia/commons/b/bb/Square_zomato_logo_new.png" style="
    width: 50%;
">
    <p>20% off </p>
</div>
                        <div class="col-md-3">400</div>
                        <div class="col-md-3"><input type="checkbox" name="vehicle3" value="Boat" "=""></div>
                </div>
                            
                            
 <div class="row cus_row">
                        <div class="col-md-6"><img src="https://media.licdn.com/dms/image/C510BAQH9zJ8AMELaeA/company-logo_200_200/0?e=2159024400&amp;v=beta&amp;t=WVf63L7q11ZWLWVpezLSh1ofOGiE8VrCCI6UwkVPCT8" style="
    width: 50%;
">
    <p>20% off </p>
</div>
